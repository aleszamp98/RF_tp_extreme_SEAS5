...
def download_chunk(years_chunk):
    ...
    # Nome del file: SEAS5_u850_{start_year}_{end_year}.nc
    filepath = OUTPUT_DIR / f"SEAS5_u850_{start_year}_{end_year}.nc"
    ...
    logging.info(f"Inizio download u850: periodo {start_year}-{end_year} -> {filepath}")
