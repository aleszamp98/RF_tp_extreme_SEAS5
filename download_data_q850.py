...
def download_chunk(years_chunk):
    ...
    # Nome del file: SEAS5_q850_{start_year}_{end_year}.nc
    filepath = OUTPUT_DIR / f"SEAS5_q850_{start_year}_{end_year}.nc"
    ...
    logging.info(f"Inizio download q850: periodo {start_year}-{end_year} -> {filepath}")
